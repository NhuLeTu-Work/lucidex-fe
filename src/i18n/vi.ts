export const vi: Record<string, string> = {
    ...
    errInvalidStudentId: 'StudentID ({val}) không hợp lệ (phải từ 2-15 ký tự chữ và số)',
    errInvalidFullname: 'Fullname không hợp lệ (độ dài 2-200, không chứa số/ký tự đặc biệt)',
    errFormatDobDetail: 'DOB ({val}) không hợp lệ (phải là ngày hợp lệ định dạng YYYY-MM-DD hoặc DD/MM/YYYY)',
    errInvalidViMajor: 'Vi-Major không hợp lệ (độ dài 2-200, không chứa số/ký tự đặc biệt)',
    errInvalidEnMajor: 'En-Major không hợp lệ (độ dài 2-200, không chứa số/ký tự đặc biệt)',
    errInvalidGradYear: 'GraduationYear ({val}) không hợp lệ (phải từ 1970 trở đi)',
    errInvalidViGradClass: 'Vi-GraduationClassification không hợp lệ (độ dài 2-200, không chứa số/ký tự đặc biệt)',
    errInvalidEnGradClass: 'En-GraduationClassification không hợp lệ (độ dài 2-200, không chứa số/ký tự đặc biệt)',
    errInvalidViMode: 'Vi-ModeOfStudy không hợp lệ (độ dài 2-200, cho phép dấu "-")',
    errInvalidEnMode: 'En-ModeOfStudy không hợp lệ (độ dài 2-200, cho phép dấu "-")',
    errInvalidEmail: 'UniversityEmail ({val}) không đúng định dạng email',
    errInvalidNationalIdDetail: 'NationalID ({val}) không hợp lệ (phải đúng 12 chữ số)',
    errInvalidClassId: 'ClassID ({val}) không hợp lệ (phải từ 2-15 ký tự chữ và số)',
    errInvalidPhone: 'Số điện thoại ({val}) không hợp lệ',
    errInternalDuplicateDetail: 'Trùng bộ khóa [StudentID: {studentId}, ClassID: {classId}] với dòng {prevRow}',
