export const vi: Record<string, string> = {
    ...
    errInvalidStudentId: 'StudentID ({val}) không hợp lệ (phải dạng B+7 chữ số, ví dụ: B1234567)',
    errInvalidFullname: 'Fullname không hợp lệ (độ dài 2-200, không chứa số/ký tự đặc biệt)',
    errFormatDobDetail: 'DOB ({val}) không hợp lệ (phải là ngày hợp lệ định dạng dd/mm/yyyy)',
    ...
    errInvalidClassId: 'ClassID ({val}) không hợp lệ (phải đúng 8 ký tự gồm chữ và số)',
