export const vi: Record<string, string> = {
    ...
    errInvalidClassId: 'Lớp ({val}) không hợp lệ (từ 2-15 ký tự chữ, số, -, _)',
    ...
    errInvalidPlaceOfBirthList: 'Nơi sinh ({val}) không thuộc danh sách 63 Tỉnh/Thành phố',
    errInvalidClassificationList: 'Xếp loại ({val}) không thuộc danh sách (Xuất sắc, Giỏi, Khá, Trung bình)',
    errInvalidDegreeTypeList: 'Loại bằng ({val}) không thuộc danh sách quy định',
    errInvalidModeOfStudyList: 'Hình thức đào tạo ({val}) không thuộc danh sách (Chính quy, Vừa học vừa làm, Đào tạo từ xa)',
