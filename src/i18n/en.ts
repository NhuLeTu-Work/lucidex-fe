export const en: Record<string, string> = {
    ...
    errInvalidClassificationList: 'Classification is not in valid list (Xuất sắc, Giỏi, Khá, Trung bình)',
    errInvalidDegreeTypeList: 'Degree type is not in recognized degree list',
    errInvalidModeOfStudyList: 'Mode of study is not in valid list (Chính quy, Vừa học vừa làm, Đào tạo từ xa)',
