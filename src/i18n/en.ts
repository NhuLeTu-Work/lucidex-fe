export const en: Record<string, string> = {
    ...
    errInvalidStudentId: 'Invalid StudentID ({val}) (must be 2-15 alphanumeric characters)',
    errInvalidFullname: 'Invalid Fullname (length 2-200, no numbers or special characters)',
    errFormatDobDetail: 'Invalid DOB ({val}) (must be a valid date in YYYY-MM-DD or DD/MM/YYYY format)',
    ...
    errInvalidEmail: 'Invalid UniversityEmail ({val})',
    errInvalidNationalIdDetail: 'Invalid NationalID ({val}) (must be exactly 12 digits)',
    errInvalidClassId: 'Invalid ClassID ({val}) (must be 2-15 alphanumeric characters)',
