export const en: Record<string, string> = {
    ...
    errInvalidStudentId: 'Invalid Student ID ({val}) (must be 2-15 chars, alphanumeric, -, _)',
    ...
    errInvalidPlaceOfBirthList: 'Place of birth ({val}) is not in valid 63 Vietnam provinces list',
    errInvalidClassificationList: 'Classification ({val}) is not in valid list (Xuất sắc, Giỏi, Khá, Trung bình)',
    errInvalidDegreeTypeList: 'Degree type ({val}) is not in recognized degree list',
    errInvalidModeOfStudyList: 'Mode of study ({val}) is not in valid list (Chính quy, Vừa học vừa làm, Đào tạo từ xa)',
