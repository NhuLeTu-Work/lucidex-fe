export const en: Record<string, string> = {
    ...
    issueType: "Type",
    issueDetail: "Detail",
    continueWithoutErrors: "Skip all error rows",
    processSelectedRows: "Process selected rows",
    selectAllFormatErrors: "Select all format error rows",
    cancelUpload: "Cancel Upload",
    uploadCancelled: "Upload process cancelled.",
    csvErrorsDetected: "CSV Data Issues Detected",
    csvErrorsDesc: "System detected formatting errors or duplicate records inside the uploaded file. You can cancel to fix your file, or proceed by ignoring these error rows.",
