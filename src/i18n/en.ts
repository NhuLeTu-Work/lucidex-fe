export const en: Record<string, string> = {
    ...
    step3: 'Organization Verifies via Code',
    ...
    roleDescIssuer: 'Issue and manage records',
    roleDescOwner: 'Your credentials',
    roleDescVerifier: 'Check a credential',
    adminPortal: 'Admin Portal',
    superAdminPortal: 'Super Admin Portal',
    dashboard: 'Dashboard',
    myCredentials: 'My Credentials',
    verifiedLinks: 'Verified Codes',
    auditLog: 'Audit Log',
    ...
    createVerifiedLink: 'Create Verified Code',
    linkExpiry: 'Code Expiry',
    hours24: '24 Hours',
    days7: '7 Days',
    days30: '30 Days',
    permanent: 'Permanent',
    ...
    timeBoundConsent: 'Time-bound Consent (h)',
    accessNumberConsent: 'Access Count Limit',
    customizeConsent: 'Customize',
    accessNumberDesc: 'Number of valid uses for shared credential code (Default: 5 times)',
    timeBoundDesc: 'Time limit after code creation (Default: 24 hours)',
    customizeDesc: 'Combine access count limits and time restrictions',
    revokeLink: 'Revoke',
    revokeConfirm: 'Are you sure you want to revoke this code?',
    noCredentials: 'No credentials found.',
    noLinks: 'No verified codes created yet.',
    ...
    noMatchingCodes: 'No matching verification codes found.',
    codeCopied: 'Code copied to clipboard!',
    codeRevokedMsg: 'Verification code revoked.',
    shareCodeTitle: 'Credential Share Code',
    accessConfig: 'Access Configuration',
    accessNumber: 'Uses',
    timeBound: 'Time',
    customize: 'Custom',
    maxAccessCountLabel: 'Max access count:',
    expireHoursLabel: 'Validity period:',
    timesUnit: 'times',
    hoursUnit: 'hours',
    saveChanges: 'Save Changes',
    createShareCode: 'Create Share Code',
    closeShareCode: 'Close Share Code',
    selectTrustedOrgs: 'Select trusted organizations...',
    ...
    welcomeVerifier: 'Hello, Verifier',
    company: 'Company',
    freeTier: 'Free Tier',
    ...
    remaining: 'remaining',
    used: 'used',
    enterLinkOrID: 'Enter Verified Code or Credential ID',
    ...
    enterLinkCode: 'Enter verification code',
    check: 'Check',
    ...
    errorMissingCreds: 'Please enter both email and password.',
    ...
    csvFormatLimit: "Accepts .csv or .xlsx file formats, maximum 10MB",
    ...
    errNotCsv: "Only .csv or .xlsx files are accepted. Please select a valid file format.",
    ...
    addManualCredential: "Add Manual Credential",
    addManualCredentialTitle: "Add Manual Credential",
    addManualCredentialDesc: "Enter credential details to add directly into the system.",
    requiredInfo: "Required Information",
    credentialInfo: "Credential Information",
    errFillAllFields: "Please fill in all required fields.",
    ...
    majorViLabel: "Major (Vietnamese)",
    majorEnLabel: "Major (English)",
    gradClassViLabel: "Graduation Classification (Vietnamese)",
    gradClassEnLabel: "Graduation Classification (English)",
    modeStudyViLabel: "Mode of Study (Vietnamese)",
    modeStudyEnLabel: "Mode of Study (English)",
    classIdLabel: "Class ID",
    nationalIdLabel: "National ID (12 digits)",
    phoneLabel: "Phone Number",
    manualOverwriteDesc: "Overwrite/update information if Student ID (student_id) already exists in the database.",
    errStudentIdRequired: "Please enter Student ID (student_id)",
    errFullNameRequired: "Please enter Student Full Name (full_name)",
    errDobRequired: "Please enter Date of Birth (dob)",
    errGradYearRequired: "Please enter a valid Graduation Year (graduation_year)",
    errUniversityEmailRequired: "Please enter University Email (university_email)",
    credentialAlreadyExistsMsg: "Student ID already exists in the system. Check \"Overwrite\" if you wish to update.",
    manualCreateSuccess: "Credential created successfully",
    manualUpdateSuccess: "Credential updated successfully",
    manualAddFailed: "Failed to add credential",
    submitManualCredential: "Add Credential",
    ...
    fileErrorsDetected: "Data Issues Found in File",
    fileErrorsDesc: "Data has been automatically categorized. You can edit directly or send valid records only.",
    csvErrorsDetected: "Data Issues Found in File",
    csvErrorsDesc: "Data has been automatically categorized. You can edit directly or send valid records only.",
    rowNumber: "Row",
    issueType: "Status",
    issueDetail: "Details",
    continueWithoutErrors: "Send valid rows only",
    processSelectedRows: "Send selected rows",
    selectAllFormatErrors: "Select all valid rows",
    cancelUpload: "Cancel Upload",
    uploadCancelled: "Upload process cancelled.",
    validRowsOnlyBtn: "Send valid rows only ({X} students)",
    sendSelectedRowsBtn: "Send {X} selected rows",
    summaryNotice: "Will send {X} students. Skipping {Y} invalid/duplicate rows.",
    statusValid: "Valid",
    statusDuplicate: "Duplicate in file",
    sectionPersonalInfo: "I. Personal Information",
    sectionAcademicInfo: "II. Academic Information",
    sectionGraduationInfo: "III. Graduation & Degree Info",
    genderLabel: "Gender",
    genderMale: "Male",
    genderFemale: "Female",
    ...
    cpaLabel: "CPA",
    autoClassificationLabel: "Classification (Auto)",
    autoFromCpaPlaceholder: "Auto-calculated from CPA",
    degreeNumberLabel: "Degree Serial Number",
    registerNumberLabel: "Register Number",
    degreeTypeLabel: "Degree / Certificate Type",
    selectDegreeTypePlaceholder: "Select Degree / Certificate Type",
    searchDegreeTypePlaceholder: "Search Degree / Certificate Type...",
    statusFormatError: "Format error",
    statusFixedValid: "Fixed & valid",
    fieldNameHeader: "Field Name",
    originalDataHeader: "Original Data",
    directEditHeader: "Inline Edit",
    selectOptionPlaceholder: "Select...",
    searchOptionPlaceholder: "Search...",
    noResultsFound: "No results found",
    enterCorrectValuePlaceholder: "Enter correct value...",
    badgeWillSend: "Will send",
    badgeWillSkip: "Will skip",
    keepFirstRowSuggest: "Keep row {row}",
    confirmCancelUploadTitle: "Confirm Cancel Upload?",
    confirmCancelUploadDesc: "Any unsaved changes made to the error records will be discarded. Are you sure you want to close?",
    confirmCloseBtn: "Confirm Close",
    continueEditingBtn: "Continue Editing",
    ekycTitle: "Setup your eKYC",
    ekycNav: "Identity Verification",
    ...
    errInvalidStudentId: 'Invalid Student ID (must be 2-15 chars, alphanumeric, -, _)',
    errInvalidFullname: 'Invalid Full Name (length 2-200, no special characters like @, #, $,...)',
    errFormatDobDetail: 'Invalid Date of Birth (must be dd/mm/yyyy format)',
    errInvalidClassId: 'Invalid Class ID (must be 2-15 chars, alphanumeric, -, _)',
    errInvalidCpaDetail: 'Invalid CPA (must be a decimal number)',
    errInvalidGradYear: 'Invalid Graduation Year (must be between 1930 and {max})',
    errInvalidGeneralText: 'Invalid field {field} (length 2-300, no special characters like @, #, $,...)',
    errInvalidPlaceOfBirthList: 'Place of birth is not in valid 63 Vietnam provinces list',
    errInvalidClassificationList: 'Classification is not in valid list (Excellent, Very Good, Good, Average)',
    errInvalidDegreeTypeList: 'Degree type is not in recognized degree list',
    errInvalidModeOfStudyList: 'Mode of study is not in valid list (Full-time, Work-study, Distance learning)',
    errInvalidEmail: 'Invalid Email format',
    errInvalidNationalIdDetail: 'Invalid National ID (must be exactly 12 digits starting with 0)',
    ...
    errUnauthorized: "Invalid or expired access token.",
    errOwnerAccessRequired: "Owner access is required.",
    errOwnerInactive: "Active owner account is required.",
    errOwnerNotFound: "Owner not found.",
    errInvalidOwnerAccount: "Invalid owner account.",
    errValidationError: "Request validation failed.",
    errInternalServerError: "An unexpected error occurred.",
    ekycVerifiedAlready: "You have already completed identity verification (eKYC) successfully!",
    goToCredentialsBtn: "Go to My Credentials",
    ekycRequiredNotice: "You have not completed identity verification (eKYC). Please verify your identity before viewing and claiming credentials.",
    goToEkycBtn: "Complete eKYC Now",
    claimCredentialsBtn: "Claim Credentials",
    errCredentialNotFound: "Credential not found for current owner.",
    errEkycNotVerified: "Identity (eKYC) is not verified.",
    errCredentialNotMatched: "Credential is not matched with your account.",
    errCredentialAlreadyClaimed: "Credential was already claimed by another owner.",
    ...
    claiming: "Claiming...",
    claimed: "Claimed",
    importSuccess: "Successfully imported credentials ({X}/{Y} records).",
    importFailed: "Failed to import credentials.",
    errorImportCredentials: "An error occurred while importing credentials.",
    resendMessage: 'A new OTP has been resent.',
    activeStudents: 'Active students',
    studentIdPlaceholder: 'e.g. 20110345',
    fullNamePlaceholder: 'e.g. John Doe',
    nationalIdPlaceholder: 'e.g. 079202012345 (12 digits)',
    universityEmailPlaceholder: 'e.g. student@ctu.edu.vn',
    classIdPlaceholder: 'e.g. SP2201A1',
    facultyPlaceholder: 'e.g. Information Technology',
    majorPlaceholder: 'e.g. Software Engineering',
    specializationPlaceholder: 'e.g. Artificial Intelligence',
    cpaPlaceholder: 'e.g. 3.45',
    degreeNumberPlaceholder: 'e.g. 012345',
    registerNumberPlaceholder: 'e.g. 152/2026/QD-DHCT',
    graduationYearPlaceholder: 'e.g. 2026',
    selectKeepRowPlaceholder: 'Select row to keep',
    keepRowDefault: 'Keep row {row} (Default)',
    keepRowThis: 'Keep this row {row}',
    selectProvincePlaceholder: 'Select Province/City',
    searchProvincePlaceholder: 'Search Province/City...',
    selectClassificationPlaceholder: 'Select Classification',
    selectModeOfStudyPlaceholder: 'Select Mode of study',
    selectGenderPlaceholder: 'Select Gender',
    genderMaleOption: 'Male (blank)',
    genderFemaleOption: 'Female (N)',
    empty: '(Empty)',
    data: 'Data',
    loadingVerifiers: 'Loading verifiers...',
    loadingVerifiersList: 'Loading verifiers list...',
    searchOrgsPlaceholder: 'Search organizations...',
    remove: 'Remove',
    copied: 'Copied',
    loadingCredentialDetails: 'Loading credential details...',
    singleVerify: 'Single Verification',
    bulkVerify: 'Bulk Verification (CSV)',
    enterShareCodePlaceholder: 'Enter share code...',
    downloadTemplateCsv: 'Download Sample CSV',
    bulkCsvLimitNote: 'CSV file supports up to 500 codes per upload.',
    dragDropBulkCsv: 'Drag & drop .csv file here or browse from computer',
    bulkCsvFormatNote: '.csv format, up to 500 codes',
    changeCsvFile: 'Change CSV File',
    selectCsvFile: 'Select CSV File',
    startBulkVerify: 'Bulk Verify',
    bulkVerifyResultsTitle: 'Verification Results ({count} codes)',
    uploadOtherCsv: 'Upload Another CSV',
    statusValidBadge: 'Valid',
    statusRestrictedOrg: 'Organization Restricted',
    statusNotFound: 'Not Found',
    reasonRestrictedOrg: 'Verifier organization restricted (Your organization is not on the Trusted Organizations list)',
    reasonExpired: 'Code has expired or exceeded maximum allowed access count',
    reasonRevoked: 'Verification code or credential was revoked by the Owner / Issuer',
    reasonNotFound: 'Verification code not found in system (Invalid or non-existent code)',
    reasonInvalid: 'Invalid',
    ownerLabel: 'Owner',
    issuerLabel: 'Issuer',
    issuedYearLabel: 'Graduation Year',
    viewDetails: 'View Details',
    loadingCredentialData: 'Loading credential data...',
    errOnlyCsv: 'Please upload .csv format files only',
    errSelectCsvFirst: 'Please select a CSV file before verifying!',
    bulkVerifySuccessToast: 'Bulk verification complete! Successfully verified {active}/{total} codes.',
    bulkVerifyFailedToast: 'Bulk verification failed!',
    errCsvNoCodes: 'CSV file contains no verification code data!',
    errCsvOver500: 'CSV file exceeds the 500 code limit!',
    errProcessCsv: 'An error occurred while processing CSV file!',
    english: 'English',
    ...
    statusFailed: 'Failed',
    errGradYearRange: 'Invalid graduation year (must be between 1930 and {maxYear})',
    errFieldInvalidChars: 'Invalid {field} (only letters, numbers, -, / allowed and no special characters @, #, $,...)',
    fieldPlaceOfBirth: 'Place of birth',
    fieldFaculty: 'Faculty / Institute',
    fieldMajor: 'Major',
    fieldSpecialization: 'Specialization',
    fieldDegreeNumber: 'Degree number',
    fieldRegisterNumber: 'Registration number',
    verifySuccessToast: 'Verification code verified successfully!',
    verifyInvalidToast: 'Verification code is invalid or expired!',
    errAccessLimitReached: 'This verification code has reached its usage limit.',
    errLinkExpired: 'This link has expired.',
    errCredentialRevoked: 'The credential associated with this link has been revoked.',
    errLinkRevoked: 'Access revoked.',
    'This verification code has reached its usage limit.': 'This verification code has reached its usage limit.',
    'This link has expired.': 'This link has expired.',
    'The credential associated with this link has been revoked.': 'The credential associated with this link has been revoked.',
    ...
    'Invalid code or code has expired.': 'Invalid code or code has expired.',
    revokeLinkFailed: 'Failed to revoke verified code.',
    settingsUpdatedSuccess: 'Default settings updated successfully.',
    settingsUpdatedFailed: 'Failed to update settings.',
    errCreateLinkFailed: 'Failed to create verified code.',
    errCredentialNotClaimed: 'Credential is not yet claimed.',
    errInvalidExpiration: 'Expiration time must be in the future.',
    errInvalidAccessCount: 'Max access count must be greater than or equal to 1.',
    errInvalidOrgId: 'Invalid organization ID.',
    errFetchVerifiedLinks: 'Failed to load verified codes.',
    other: 'Other',
    bachelorDegree: "Bachelor's Degree",
    bachelorDegreeUpper: "BACHELOR'S DEGREE",
    graduationCertificate: "Graduation Certificate",
    defaultIssuerName: "Can Tho University",
    degreeClassification: "Degree / Certificate",
};