export const en: Record<string, string> = {
    ...
    errInvalidNationalId: "Missing or invalid National ID (hashed)",
    ...
    errFormatDob: "Invalid Date of Birth format (expected YYYY-MM-DD).",
    errInternalDuplicate: "This row contains duplicate data with another row in this file.",
